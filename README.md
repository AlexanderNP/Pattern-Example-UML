...
## Пример на беке
Исходя из моего опыта взаимодействия с Node js сервером и написания серверных приложений, все стараются ПРИДЕРЖИВАТСЯ или даже сами того не понимая используего данный архитектурный стиль.
